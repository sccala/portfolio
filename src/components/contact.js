    ...
    <>
      <section id='contact'>
        ...
        <div className='text-center md:flex my-8'>
          <div className='text-base text-primary md:text-left  md:w-2/5'>
            Got any question? Let's chat (or connect)
          </div>
          <div className='mt-8 md:w-3/5 justify-content-center'>
            <a
              className='border rounded-lg border-primaryborder px-8 py-1 mr-1 md:mx-4 text-primary bg-tertiary hover:bg-secondary duration-100 text-sm inline-block'
            ...
            <a
              className='border rounded-lg border-primaryborder px-8 py-1 mr-1 md:mx-4 text-primary text-sm hover:bg-secondary duration-100 inline-block bg-tertiary'
